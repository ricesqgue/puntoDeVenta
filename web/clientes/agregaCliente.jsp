...
<%
    ...
    String query ="select idCliente from cliente where concat_ws(' ', nombre,apellidoPaterno, apellidoMaterno) = '"+nombre +" "+apePat+" "+ apeMat+"';"; 
    ...
    if(n>0){
        ...
        //Se procede a agregar al cliente.
        ...
        if(objConn.rs == null){
            ...
            query = "insert into cliente values (default,'"+nombre+"','"+apePat+"','"+apeMat+"','"+telefono+"','"+email+"',"
            ...
            if(objConn.Update(query)==1){
                ...
                json.put("error", "<br><div class='row animated slideInLeft'> <div class='col-md-4 col-md-offset-3'>"
                        ...
                        + "<button type='button' class='close' data-dismiss='alert' aria-label='Close'>"
                        + "<span aria-hidden='true'>&times;</span></button>"
                        + "<strong>Error. </strong> No se pudo agregar al cliente."
                        + "</div></div></div>" );               
            }
