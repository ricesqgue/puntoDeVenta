<%-- 
    Document   : pagoProveedores
    Created on : 10/12/2015, 07:51:11 PM
    Author     : ricesqgue
--%>
<%
	...
	<div class="jumbotron">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 class="modal-title">Detalle de abono</h3>
                        </div>
        ...
        <script type="text/javascript">
            ...
            function consultaReporte(){ 
                ...
                $("#msj").html("");
                $.post("reportePagoProveedores.jsp",{fechaInicial: inicial, fechaFinal: final},function(res){
            ...
            function detalleAbono(id){
                $.post("detalleAbono.jsp",{id: id}, function(res){
