        ...
        <script type="text/javascript"> 
            ...
            function exportaExcel(){
                var pdf = function () {
                    ...
                    doc.text("Productos vendidos", 40, 50);
                    var res = doc.autoTableHtmlToJson(document.getElementById("tablaReporte"));
                    doc.autoTable(res.columns, res.data, {startY: 60, theme: 'grid'});
                    return doc;
                };
